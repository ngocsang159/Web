#pragma checksum "E:\DO_AN\Shop\SmartPhone.Web\Areas\Admin\Views\CategoryProduct\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "38399dc2a9459fccb6d547a6a1e57def04bbeb70"
// <auto-generated/>
...
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"38399dc2a9459fccb6d547a6a1e57def04bbeb70", @"/Areas/Admin/Views/CategoryProduct/Index.cshtml")]
    public class Areas_Admin_Views_CategoryProduct_Index : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        public async override global::System.Threading.Tasks.Task ExecuteAsync()
        {
            WriteLiteral("\r\n");
#nullable restore
#line 2 "E:\DO_AN\Shop\SmartPhone.Web\Areas\Admin\Views\CategoryProduct\Index.cshtml"
...
#nullable restore
#line 75 "E:\DO_AN\Shop\SmartPhone.Web\Areas\Admin\Views\CategoryProduct\Index.cshtml"
...
");
                ...
                $.ajax({
                    url: '/Admin/CategoryProduct/_TableView',
                    type: ""post"",
                    dataType: 'html',
                    data: {
            ...
            function hrefListNew() {
                $('.btnHref').click(function () {
                    ...
                    location.href = ""/Admin/Product/Index/"" + Id;
                })
            }
            ...
            function ViewDetail() {
                ...
                WriteLiteral(@"function () {
                    let Id = $(this).attr('data-id');
                    $.ajax({
                        url: '/Admin/CategoryProduct/_ViewDetail',
                        type: 'post',
                        dataType: 'html',
                        data: {
                            Id: Id
            ...
            function SetObjectToForm() {
                $('.btnEdit').click(function () {
                    let Id = $(this).attr('data-id');
                    $.ajax({
                        url: '/Admin/CategoryProduct/GetCatogoryByID',
                   ");
     ...
     ");
                    ...
                    swal({
                        ...
                        .then((willDelete) => {
                            if (willDelete) {
                                ...
                                let btn = $(this);
                                $.ajax({
                                    url: '/Admin/CategoryProduct/DeleteByID',
                                    type: 'post',
                                    dataType: 'json',
                               ");
                WriteLiteral(@"     data: {
            ...
            function AddOrUpdate() {
                $('.btnSave').click(function () {
                    if (CheckValidate()) {
                        let categoryProduct = new O");
                WriteLiteral(@"bject();
                        $('.objInfor input').each(function (index, item) {
                            categoryProduct[$(this).attr('name')] = $(this).val();
                        })
                        categoryProduct[""Status""] = $('#s1').is(':checked') == 1 ? 1 : 0;
                        // submit data
                        console.log(categoryProduct);
                        $.ajax({
                            url: '/Admin/CategoryProduct/AddOrUpdate',
                            type: 'post',
                            dataType: 'json',
                            data: {
        ...
        ");
            ...
            // cha");
                WriteLiteral(@"nge view data

            function SearchData() {
                $('.searchInput').keyup(function () {
                    let search = $(this).val();
                    search = search.trim();
                    GetDataTable(1, pageSize, search);
                })
            }
